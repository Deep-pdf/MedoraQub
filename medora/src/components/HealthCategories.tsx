      ...
      <div className="max-w-screen-xl mx-auto px-12 md:px-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 lg:gap-6">
          {categories.map((cat, index) => (
            <div key={index} className="bg-[#006D5B] px-3 py-6 rounded-2xl hover:translate-y-[-4px] active:scale-95 transition-all duration-300 flex flex-col items-center text-center cursor-pointer shadow-md hover:shadow-lg">
